...
| OB-33 | `OB-33-Dprime-subell-lemma-gate-a.md` | D' | **GATE-A (resend)**: narrowed 𝒞_logpoly^{sub,ell} leading-singularity lemma (elliptic principal symbol + strictly-lower-order log ⇒ pure-power leading heat trace; Hörmander 1968 Thm 1.1 + Karamata; (I−Δx)(I−Δy) shows ellipticity load-bearing) | OPEN — send for review |
