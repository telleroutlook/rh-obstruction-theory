...
For the 4|n sub-family, the impossibility is even stronger: NEITHER A⁺ nor A⁻
individually can be of the form 5^e·m².
...
### M3 — 4|n sub-family: individual A⁺/A⁻ not square-based powerful

The individual statement (not just simultaneous) for 4|n — that neither A⁺ nor A⁻
can be 5^e·m² — is a bonus result. It follows from the same mod-8/16 argument.
This is stronger than needed for the t=1 case of NT-C but is worth recording.
